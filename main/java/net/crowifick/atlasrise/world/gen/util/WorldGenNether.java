package net.crowifick.atlasrise.world.gen.util;
...
public class WorldGenNether extends WorldGenerator {
    ...
    public WorldGenNether(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.netherrack);
    }

    public WorldGenNether(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenNether(Block block, int meta, int number, Block target)
    {
